	...
	<div class="main">
		...
		<div class="item">
			...
			<div class="content">
				...
				<h1>Improved safety AND better wages: Troubleshooting from the hip</h1>

				<div class="body">
					<figure>
  <img src="img/ID-10046633.jpg"
 alt="Image courtesy of Worakit Sirijinda at FreeDigitalPhotos.net">
  <figcaption>
Image courtesy of Worakit Sirijinda at FreeDigitalPhotos.net<br /><br />
</figcaption>
</figure>
		...
		<div class="item">
			...
			<div class="content">
				...
				<h1>Changing the IT culture in Chile: Keeping Traditions</h1>
